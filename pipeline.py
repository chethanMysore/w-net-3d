...
from evaluation.metrics import (SoftNCutsLoss, ReconstructionLoss, l2_regularisation_loss, SimilarityLoss, ContinuityLoss)
...
class Pipeline:
    ...
    def validate(self, training_index, epoch):
        ...
        total_soft_ncut_loss, total_reconstr_loss, total_similarity_loss, total_continuity_loss, total_loss = 0, 0, 0, 0, 0
        no_patches = 0
        self.model.eval()
        try:
